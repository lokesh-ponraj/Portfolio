...
const Data = () => {
  return (
    <div className="home__data">
      <small>I'm</small>
      <h1 className="home__title"><motion.span className="wave-text" 
      transition={{
        duration: 2,
        repeat: Infinity,
        repeatType: 'loop',
      ...
      <h3 className="home__subtitle">Cross-platform app developer</h3>
      <p className="home__description">With passion for developing optimised solutions.</p>

      <motion.a href="#contact" className="button button--flex" whileHover={{ scale: 1.1 }}
        transition={{ type: "spring", stiffness: 500, damping: 30 }}>Reach me
        <motion.svg
          class="button__icon"
          xmlns="http://www.w3.org/2000/svg"
          width="24"
